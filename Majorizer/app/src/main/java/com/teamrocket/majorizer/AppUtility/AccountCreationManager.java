...
public class AccountCreationManager {
    ...
    public static void createNewAdvisorAccount(final Context context, final EditText usernameField, final EditText passwordField, final EditText passwordRetryField, final EditText firstNameField, final EditText lastNameField, final String department) {
