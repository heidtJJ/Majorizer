...
public class CreateAdvisorAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the fields for each input.
    ...
    public void createNewAdvisorAccount(final View view) {
        ...
        administrator.createNewAdvisorAccount(this, department, username, password, firstName, lastName);
        ...
        departmentRadioGroup.clearCheck();
    }
